...
export default function ArticlesPage() {
  ...
  if (loading || !user) {
    return <div className="dash-loading">Loading articles...</div>;
  }
      ...
      <div className="dash-main">
        ...
        <main className="dash-content">
          <div className="dash-page-header">
            <div>
              <h1>📚 Articles</h1>
              <p>Read agricultural guidance and expert insights.</p>
            </div>
          </div>

          <div className="dash-banner">
            <BadgeCheck size={16} />
            Articles feature coming soon! You'll find farming tips and expert advice here.
          </div>

          <div className="dash-empty-state">
            <BookOpen size={48} className="text-gray-300" />
            <h3>No articles yet</h3>
            <p>Check back soon for expert agricultural articles and guides.</p>
          </div>
