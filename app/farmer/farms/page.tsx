...
export default function FarmsPage() {
  ...
  if (loading || !user) {
    return <div className="dash-loading">Loading your farms...</div>;
  }
      ...
      <div className="dash-main">
        ...
        <main className="dash-content">
          <div className="dash-page-header">
            <div>
              <h1>🌾 My Farms</h1>
              <p>Manage and monitor all your farm locations.</p>
            </div>
          ...
          <div className="dash-banner">
            <BadgeCheck size={16} />
            Farms feature coming soon! You'll be able to add and manage multiple farms here.
          </div>

          <div className="dash-empty-state">
            <Sprout size={48} className="text-gray-300" />
            <h3>No farms yet</h3>
            <p>Add your first farm to start tracking your agricultural activities.</p>
            <button className="btn btn-primary">
