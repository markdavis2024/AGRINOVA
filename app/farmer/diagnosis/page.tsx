...
export default function DiagnosisPage() {
  ...
  if (loading || !user) {
    return <div className="dash-loading">Loading diagnosis...</div>;
  }
      ...
      <div className="dash-main">
        <header className="dash-topbar">
          ...
          <div className="dash-search">
            <Search size={16} />
            <input type="text" placeholder="Search diagnoses..." />
          </div>
        ...
        <main className="dash-content">
          <div className="dash-page-header">
            <div>
              ...
              <p>Get expert help with crop issues by uploading photos and descriptions.</p>
            </div>
          ...
          <div className="dash-banner">
            <BadgeCheck size={16} />
            Diagnosis feature coming soon! You'll be able to upload crop issues for expert review.
          </div>

          <div className="dash-empty-state">
            <Stethoscope size={48} className="text-gray-300" />
            <h3>No diagnoses yet</h3>
            <p>Submit your first crop diagnosis request.</p>
            <button className="btn btn-primary">
              <Plus size={16} /> Request Diagnosis
            </button>
          </div>
