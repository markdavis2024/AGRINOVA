...
export default function AdminRegisterPage() {
  ...
  function validateStep(current: number) {
    ...
    if (current === 2) {
      if (!form.organization) {
        setError("Please tell us which organization you represent.");
        return false;
      }
    }
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (authLetter) fd.set("authLetter", authLetter);
      ...
      <div className="auth-shell">
        <div className="auth-card">
          <div className="auth-card-header">
            <span className="mini-tag">🛡️ ADMINISTRATOR REGISTRATION</span>
            <h1>Create your admin account</h1>
            <p>
              Administrator accounts are for authorized personnel who manage
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            {step === 1 && (
              <div className="auth-step-panel">
                ...
                <label className="login-field">
                  <span>Position / department (optional)</span>
                  <div className="login-input">
                    <Briefcase size={16} />
                    <input
                      type="text"
                      placeholder="e.g. IT Manager, Platform Operations"
                      value={form.position}
            ...
            {step === 2 && (
              <div className="auth-step-panel">
                ...
                <label className="login-field">
                  <span>Admin invitation code (optional)</span>
                  <div className="login-input">
                    <KeyRound size={16} />
                    <input
                      type="text"
                      placeholder="If you received one by email"
                ...
                <div className="login-field">
                  <span>Authorization letter / official ID (optional)</span>
                  <label className="auth-upload">
                    <Upload size={18} />
                    <div>
                      <strong>
                        {authLetter ? authLetter.name : "Click to upload"}
                      </strong>
                      <small>
